...
const click=()=>{
  ...
  const as=[...todo,{name,email,needs}]
  setTodo(as)
  console.log(todo)
}
...
const buttonStyle = {
  ...
  <div className="text-section">
    ...
    <button className="button" href="#">Tell Us About your Project →</button>
  </div>
...
<div style={{fontFamily:'sans-serif',textAlign:"center"}}><header className="header">
      ...
      <div className="hidden" style={{ display: "flex", maxWidth: "1200px", margin: "50px auto", border: "1px solid #003366", borderRadius: "10px", overflow: "hidden" }}>
      <div style={{ backgroundColor: "#142e8f", color: "white", padding: "40px", width: "100%", fontSize: "24px", fontWeight: "bold", display: "flex", flexDirection: "column", justifyContent: "center" }}>
      ...
      <div style={{ padding: "40px", width: "100%" }}>
        ...
        <button  onClick={click} type="submit" style={buttonStyle}>Let's Talk</button>
      </div>
    </div><br /><br /><br /><br />
